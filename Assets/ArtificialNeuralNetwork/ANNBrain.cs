...
{
    ANN ann;
    double sumSquareError = 0; //o quao "verdadeiro" eh o resultado quanto maior melhor
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < 1000; i++)//cada loop eh um epoch (nesse caso de uma operacao XnOR
        {
            sumSquareError = 0;
            result = Train(1, 1, 0);
